...
def test(times):
    for test in bf_tests:
        for i in range(times):
            Brainfuck.compare(test)
def main():
    print("Available languages: Brainfuck, Reversefuck, Pikalang.")
    print("Use {the name of language}.execute(raw_string) to decrypt.")
    print("For larger raw string, consider using execute_op instead.")
